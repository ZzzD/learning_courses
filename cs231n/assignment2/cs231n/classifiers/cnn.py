...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        conv_height, conv_width = H + 2 * pad - filter_size + 1, W + 2 * pad - filter_size + 1
        pool_height, pool_width = (conv_height - 2) // 2 + 1, (conv_width - 2) // 2 + 1
        self.params['W2'] = np.random.normal(0, weight_scale,
                                             size=(num_filters * pool_height * pool_width, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        out, affine_relu_cache = affine_relu_forward(out, self.params['W2'], self.params['b2'])
        ...
        dout = np.reshape(dout, pool_shape)
